...
public class Constant {
	...
	* XML文件路径，结账信息
	*/
	public static final String JieZhang_XmlPath = Environment.getExternalStorageDirectory().getPath()
										+ "/DianCan/db/JieZhang.xml"; 
//	/**
//	* 数据库文件路径，用于保存菜单信息
//	*/
...
//										+ "/DianCan/db/CaiDan.db3";  
	...
	* 数据库中保存推荐规则的table名
	*/
	public static final String table_jiezhang = new String("结账");
	/**
